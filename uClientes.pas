...
type
  ...
  TfrmClientes = class(TForm)
    ...
    procedure rt_salvarEdicaoClick(Sender: TObject);
...
procedure TfrmClientes.Image3Click(Sender: TObject);
begin
  TabControl1.TabIndex := 0;
end;
...
procedure TfrmClientes.Image6Click(Sender: TObject);
begin
...
procedure TfrmClientes.rt_deletarClick(Sender: TObject);
var id_cliente : integer;
begin
...
procedure TfrmClientes.rt_salvarEdicaoClick(Sender: TObject);
var vCliente : TCliente;
begin
